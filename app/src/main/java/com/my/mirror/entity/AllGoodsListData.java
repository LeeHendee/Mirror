...
public class AllGoodsListData implements Serializable {
    ...
    public static class DataEntity {
        ...
        public static class ListEntity implements Serializable{
            ...
            public static class WearVideoEntity implements Serializable{
                private String type;
                private String data;

                public static WearVideoEntity objectFromData(String str) {

                    return new Gson().fromJson(str, WearVideoEntity.class);
                }

                public static WearVideoEntity objectFromData(String str, String key) {

                    try {
                        JSONObject jsonObject = new JSONObject(str);

                        return new Gson().fromJson(jsonObject.getString(str), WearVideoEntity.class);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                ...
                public static List<WearVideoEntity> arrayWearVideoEntityFromData(String str) {

                    Type listType = new TypeToken<ArrayList<WearVideoEntity>>() {
                    }.getType();

                    return new Gson().fromJson(str, listType);
                }

                public static List<WearVideoEntity> arrayWearVideoEntityFromData(String str, String key) {
